<footer class="main-footer">
    ...
    <strong>Copyright &copy; <?= date('Y') ?> <a href="https://smartitplus.com/" target="blank">SmartDev</a>.</strong> All rights reserved.
</footer>
...
<script>
    // Dapatkan elemen checkbox dan tombol "Save"
    var setujuCheckbox = document.getElementById("setujuCheckbox");
    var saveButton = document.getElementById("saveButton");

    // Tambahkan event listener untuk memantau perubahan pada checkbox
    setujuCheckbox.addEventListener("change", function() {
        // Jika checkbox dicentang, aktifkan tombol "Save"
        if (setujuCheckbox.checked) {
            saveButton.disabled = false;
        } else {
            // Jika checkbox tidak dicentang, nonaktifkan tombol "Save"
            saveButton.disabled = true;
        }
    });
</script>
<script>
 // Konfirmasi Logout / Aksi Lain
...
<style>
/* Membesarkan modal SweetAlert */
.swal2-popup.popup-lg {
    max-width: 650px !important;   /* default 32em (512px) */
